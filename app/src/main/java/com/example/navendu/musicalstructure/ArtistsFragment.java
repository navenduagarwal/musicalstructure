...
public class ArtistsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        desc.setText(getResources().getString(R.string.description_artists));

        //Update Text hurdles
        TextView hurdle = (TextView) rootView.findViewById(R.id.text_hurdles);
        hurdle.setText(getResources().getString(R.string.hurdles_artists));

        //Update Text Description
        TextView solutions = (TextView) rootView.findViewById(R.id.text_solution);
        solutions.setText(getResources().getString(R.string.solution_artists));

        //Update text Button One
        Button buttonOne = (Button) rootView.findViewById(R.id.button_one);
        buttonOne.setText(getResources().getString(R.string.button_one_artists));
